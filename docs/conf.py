...
man_pages = [
    (
        "man/shoestring-wm.1",
        "shoestring-wm",
        "lightweight Wayland window manager",
        [author],
        1,
    ),
    (
        "man/shoestring-wm.5",
        "shoestring-wm",
        "shoestring-wm configuration file format",
        [author],
        5,
    ),
    (
    ...
    (
        ...
        "shoestring-menu",
        "dmenu-style launcher for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-ctl",
        "reference IPC client for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-tasks",
        "console window/workspace manager for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-confirm",
        "modal yes/no confirmation dialog for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-kill",
        "click-to-close window picker for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-lock",
        "screen locker for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-notify",
        "desktop notification daemon for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "shoestring-region",
        "interactive region picker for shoestring-wm",
        [author],
        1,
    ),
    (
        ...
        "screenshot tool for shoestring-wm",
        [author],
        1,
    ),
]
